package com.jface.treeviewer.parts;
...
public class FileBrowserPart {
	...
	private static final ViewerComparator ViewerComparator = null;
...
//                        new FileModifiedLabelProvider(dateFormat)));
        ...
        //viewer.setInput(new FolderNode(new File("/home/zecarlos/Documents/Teste/")));
//        viewer.setComparator(new ViewerComparator() {
//    		@Override
//    		public int compare(Viewer viewer, Object e1, Object e2) {
//    			if (e1 != null  && e2 != null) {
//    				return Integer.valueOf(e1.toString()).compareTo(Integer.valueOf(e2.toString()));
//    			}
...
//        tree.setSortColumn(fileSizeColumn.getColumn());
...
//        viewer.refresh();
    ...
    private ImageDescriptor createImageDescriptor() {
        ...
        URL url = FileLocator.find(bundle, new Path("icons/open_in_app.png"), null);
